...
class AdaptiveLeNet5(LeNet5, Registry):
    ...
    def __init__(self, n_classes, input_shape, *args, **kwargs):
        ...
        self.conv1 = Conv2D(_n(6, 6), kernel_size=_s(5, 2), strides=_s(1, 1), activation=tf.nn.tanh, **self._)
        self.pool1 = AveragePooling2D(pool_size=_s(2, 2), strides=_s(2, 1), padding='same')
        self.conv2 = Conv2D(_n(6, 6), kernel_size=_s(5, 2), strides=_s(1, 1), activation=tf.nn.tanh, padding='valid')
